...
public class SimpleRocket : DamageBase
{
    ...
    public override void Init(DamageStruct damageStruct, bool overrideData)
    {
    ...
    private void Move()
    {
        transform.position = MathParabola.Parabola(startPos, target.position, height, time / flyTime);

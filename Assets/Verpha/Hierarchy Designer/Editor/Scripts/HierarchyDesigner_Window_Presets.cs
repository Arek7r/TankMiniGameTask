...
namespace Verpha.HierarchyDesigner
{
    public class HierarchyDesigner_Window_Presets : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            applyToTag = HierarchyDesigner_Shared_GUI.DrawToggle("Hierarchy Tag", toggleLabelWidth, applyToTag);
            applyToLayer = HierarchyDesigner_Shared_GUI.DrawToggle("Hierarchy Layer", toggleLabelWidth, applyToLayer);

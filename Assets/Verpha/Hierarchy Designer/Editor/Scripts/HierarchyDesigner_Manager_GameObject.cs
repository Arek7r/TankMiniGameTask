...
namespace Verpha.HierarchyDesigner
{
    public static class HierarchyDesigner_Manager_GameObject
    {
        ...
        private static Dictionary<int, (Color textColor, Color backgroundColor, int fontSize, FontStyle fontStyle, TextAnchor textAnchor, HierarchyDesigner_Configurable_Separator.SeparatorImageType separatorImageType)> separatorCache = new Dictionary<int, (Color textColor, Color backgroundColor, int fontSize, FontStyle fontStyle, TextAnchor textAnchor, HierarchyDesigner_Configurable_Separator.SeparatorImageType separatorImageType)>();
        #endregion
        #endregion
        #endregion
        ...
        private static List<(Component component, Texture2D icon)> CacheComponentIcons(GameObject gameObject)
        {
            ...
            foreach (Component component in gameObject.GetComponents<Component>())
            {
                ...
                if (excludeTransformComponent)
                {
                    if (component is Transform || component is RectTransform) continue;
                }
                if (excludeCanvasRendererComponent)
                {
        ...
        private static void DrawSeparator(GameObject gameObject, Rect selectionRect, int instanceID)
        {
            ...
            if (!separatorCache.TryGetValue(instanceID, out var separatorInfo))
            {
                ...
                separatorInfo = (separatorData.TextColor, separatorData.BackgroundColor, separatorData.FontSize, separatorData.FontStyle, separatorData.TextAnchor, separatorData.ImageType);
        ...
        public static Dictionary<int, (Color textColor, Color backgroundColor, int fontSize, FontStyle fontStyle, TextAnchor textAnchor, HierarchyDesigner_Configurable_Separator.SeparatorImageType separatorImageType)> SeparatorCache
        {
            set
            {
